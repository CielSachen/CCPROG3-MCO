...
public class TruckController {
    ...
    public Truck createTruck() {
        ...
        if (this.service.isOccupiedLocation(location)) {
            System.out.println(PrintColor.setColor("A truck already exists on this location!", PrintColor.RED));
                    ...
                    if (storageId < StorageBin.STANDARD_TRUCK_AMOUNT) {
                        switch (chosenItemId) {
                            ...
                            default:
                                ...
                                System.out.println(PrintColor.setColor(Input.INTEGER_ID_ERROR_MESSAGE, PrintColor.RED));
